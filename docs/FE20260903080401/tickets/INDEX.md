...
| [07](07-understand-design-plan.md) | M5 | 06 | [规格](07-understand-design-plan/spec/07-understand-design-plan-spec.md)与 01-05 子票已实现；自动化验证完成后仍保留 Ticket 06 真实 Codex/原生 Windows证据缺口 |
