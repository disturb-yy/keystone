...
| `change_http.go` | Change 创建、查询、生命周期命令、HumanDecision、Trace、Artifact 内容、Execute/Execution 路由和只读 Ticket Graph Handler |
| `execution.go` | 显式 Execute、Worktree provisioning Port 组合和安全 ExecutionReadModel/error mapping |
