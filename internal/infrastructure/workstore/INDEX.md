...
AgentRun、HumanDecision、Event、WorkerInstance、Lease、Report receipt 和 Artifact authority
...
| `worker_store.go` | Worker 注册鉴权、Heartbeat/Pull、Assignment、Report classification、Artifact transaction 和重启/丢失收敛 |
...
| `worker_store_test.go` | Assignment/Lease、首次 Report、duplicate、late trace 和 daemon restart 收敛测试 |
